! function e(t, n, i) {
    ...
    1: [function(e, t, n) {
        ...
        o(function() {
            function e(e, t) {
                ...
                return n.presentationWidth -= n.presentationHeight * u.margin, n.presentationHeight -= n.presentationHeight * u.margin, "string" == typeof n.width && /%$/.test(n.width) && (n.width = parseInt(n.width, 10) / 100 * n.presentationWidth),
                    "string" == typeof n.height && /%$/.test(n.height) && (n.height = parseInt(n.height, 10) / 100 * n.presentationHeight),
                    n
            }
            o("body").removeClass("before").show().jpreLoader(), o.isDevice &&  o(".null-slide-bottom span").click(function() {
            ...
            ! function() {
                function e(e, t) {
                    ...
                    return n.presentationWidth -= n.presentationHeight * i.margin, n.presentationHeight -= n.presentationHeight * i.margin, "string" == typeof n.width && /%$/.test(n.width) && (n.width = parseInt(n.width, 10) / 100 * n.presentationWidth),
                        "string" == typeof n.height && /%$/.test(n.height) && (n.height = parseInt(n.height, 10) / 100 * n.presentationHeight),
                        n
                }
            ...
            m.each(function() {
                ...
                css3: !0,
                easing: "linear",
                easingcss3: "cubic-bezier(0.65, 0, 0, 1)",
        ...
        ! function(e) {
            e.fn.extend({
                airport: function(t) {
                    ...
                    var o = e(this),
                        r = [" ", "0", "1", "2", "3", "4", "5", "6", "7", "8", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", "-"],
                        s = 0,
                        a = items2 = t.length;
                    for (e(this).empty(); a--;)
            ...
            e.fn.fullpage = function(t) {
                ...
                function L(n, i) {
                    ...
                    if (n != 'nicer_way') {
                        ...
                        document.getElementsByClassName('presenting_sponsor')[0].classList.add('offset');
                        document.getElementsByClassName('title_sponsor')[0].classList.add('offset');
                        document.getElementsByClassName('co-title_sponsor')[0].classList.add('offset');
                        document.getElementsByClassName('sbi_sponsor')[0].classList.add('offset');
                    } else {
                        document.getElementsByClassName('logo')[0].classList.remove('offset');
                        document.getElementsByClassName('presenting_sponsor')[0].classList.remove('offset');
                        document.getElementsByClassName('title_sponsor')[0].classList.remove('offset');
                        document.getElementsByClassName('co-title_sponsor')[0].classList.remove('offset');
                        document.getElementsByClassName('sbi_sponsor')[0].classList.remove('offset');
                    }
                }
                ...
                function R(t, n) {
                    if ("undefined" == typeof n && (n = 0), isNaN(t))
                ...
                e.fn.fullpage.setAllowScrolling(!0), t.css3 && (t.css3 = Y()), e(this).length ? (fe.css({
                    ...
                    n.length && (0 != e(".fp-section.active").index(".fp-section") || 0 == e(".fp-section.active").index(".fp-section") && 0 != n.index()) && Z(n), t.fixedElements && t.css3 && e(t.fixedElements).appendTo("body"), t.navigation && (ce.css("margin-top", "-" + ce.height() / 2 + "px"),
                        ce.find("li").eq(e(".fp-section.active").index(".fp-section")).find("a").addClass("active")), t.menu && t.css3 && e(t.menu).closest(".fullpage-wrapper").length && e(t.menu).appendTo("body"), t.scrollOverflow ? ("complete" === document.readyState && o(), e(window).on("load", o)) : e.isFunction(t.afterRender) && t.afterRender.call(this), C();
                ...
                e(window).on("hashchange", b), e(document).keydown(function(n) {
                    if (t.keyboardScrolling && t.autoScrolling && ((40 == n.which || 38 == n.which) && n.preventDefault(), !ge))
                        switch (n.which) {
                            case 38:
                            case 33:
    ...
    8: [function(e, t, n) {
        ! function(e, n) {
            ...
            function E(e, t, n) {
                ...
                if (0 >= o || null == o) {
                    if (o = b(e, t, r), (0 > o || null == o) && (o = e.style[t]), qe.test(o))
                        return o;
            ...
            function M(e, t) {
                for (var n, i, o, r = [], s = 0, a = e.length; a > s; s++)
                    i = e[s], i.style && (r[s] = ve.get(i, "olddisplay"), n = i.style.display, t ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Te(i) && (r[s] = ve.access(i, "olddisplay", x(i.nodeName)))) : r[s] || (o = Te(i), (n && "none" !== n || !o) && ve.set(i, "olddisplay", o ? n : ee.css(i, "display"))));
                for (s = 0; a > s; s++)
            ...
            function P(e, t) {
                ...
                for (t = t ? 1 : 0; 4 > i; i += 2 - t)
                    n = Se[i], o["margin" + n] = o["padding" + n] = e;
            ...
            function j(e, t, n) {
                ...
                if (!ee.isEmptyObject(d)) {
                    ...
                    for (i in d)
                        s = D(f ? h[i] : 0, i, u), i in h || (h[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
                }
            }
            ...
            ee.fn = ee.prototype = {
                ...
                for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || ee.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
                    if (null != (e = arguments[a]))
                        for (t in e)
                            n = s[t], i = e[t], s !== i && (c && i && (ee.isPlainObject(i) || (o = ee.isArray(i))) ? (o ? (o = !1, r = n && ee.isArray(n) ? n : []) : r = n && ee.isPlainObject(n) ? n : {}, s[t] = ee.extend(c, r, i)) : void 0 !== i && (s[t] = i));
                return s
            }, ee.extend({
                ...
                each: function(e, t, i) {
                    ...
                    if (i) {
                        if (a)
                            ...
                            for (r in e)
                                if (o = t.apply(e[r], i), o === !1)
                                    break
                    } else if (a)
                        for (; s > r && (o = t.call(e[r], r, e[r]), o !== !1); r++);
                    else
                        for (r in e)
                            if (o = t.call(e[r], r, e[r]), o === !1)
                                break;
                    return e
                },
                trim: function(e) {
            ...
            var oe = function(e) {
                function t(e, t, n, i) {
                    ...
                    if ((t ? t.ownerDocument || t : W) !== j && D(t), t = t || j, n = n || [], !e || "string" != typeof e)
                        return n;
                    ...
                    if (H && !i) {
                        ...
                        if (T.qsa && (!I || !I.test(e))) {
                            if (h = d = R, g = t, m = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
                                for (c = p(e), (d = t.getAttribute("id")) ? h = d.replace(xe, "\\$&") : t.setAttribute("id", h), h = "[id='" + h + "'] ", l = c.length; l--;)
                                    c[l] = h + f(c[l]);
                ...
                function h(e, t, n) {
                    ...
                    return t.first ? function(t, n, r) {
                        ...
                        if (s) {
                            ...
                            for (; t = t[i];)
                                if (1 === t.nodeType || o) {
                                    if (l = t[R] || (t[R] = {}), (a = l[i]) && a[0] === B && a[1] === r)
                                        return c[2] = a[2];
                ...
                function v(e, t, n, o, r, s) {
                    return o && !o[R] && (o = v(o)), r && !r[R] && (r = v(r, s)), i(function(i, s, a, l) {
                        var c, u, d, p = [],
                            ...
                            y = n ? r || (i ? e : h || o) ? [] : s : v;
                        if (n && n(v, y, a, l), o)
                            for (c = m(y, f), o(c, [], a, l), u = c.length; u--;)
                                (d = c[u]) && (y[f[u]] = !(v[f[u]] = d));
                        if (i) {
                            if (r || e) {
                                if (r) {
                            ...
                            y = m(y === s ? y.splice(h, y.length) : y), r ? r(null, s, y, l) : J.apply(s, y)
                    })
                }
                ...
                function b(e, t, n, i) {
                    ...
                    if (!i && 1 === c.length) {
                        if (r = c[0] = c[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && T.getById && 9 === t.nodeType && H && C.relative[r[1].type]) {
                            if (t = (C.find.ID(s.matches[0].replace(be, Se), t) || [])[0], !t)
                                return n;
                ...
                T = t.support = {}, E = t.isXML = function(e) {
                    ...
                    if ((e.ownerDocument || e) !== j && D(e), n = n.replace(de, "='$1']"), !(!T.matchesSelector || !H || F && F.test(n) || I && I.test(n)))
                        try {
                            var i = O.call(e, n);
            ...
            ee.extend({
                ...
                data: function(e, t) {
                    ...
                    if (void 0 === e) {
                        if (this.length && (o = ye.get(r), 1 === r.nodeType && !ve.get(r, "hasDataAttrs"))) {
                            for (n = s.length; n--;)
                                i = s[n].name, 0 === i.indexOf("data-") && (i = ee.camelCase(i.slice(5)), l(r, i, o[i]));
                    ...
                    return "object" == typeof e ? this.each(function() {
                        ...
                        if (r && void 0 === t) {
                            if (n = ye.get(r, e), void 0 !== n)
                                return n;
                            if (n = ye.get(r, i), void 0 !== n)
                                return n;
                            if (n = l(r, i, void 0), void 0 !== n)
                                return n
                        } else
                            this.each(function() {
                                var n = ye.get(this, i);
                ...
                promise: function(e, t) {
                    ...
                    for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)
                        n = ve.get(r[s], e + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
            ...
            ee.event = {
                ...
                add: function(e, t, n, i, o) {
                    ...
                    if (m)
                        for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = ee.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                            ...
                            a = Ae.exec(t[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (d = ee.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = ee.event.special[f] || {}, u = ee.extend({
                                type: f,
                                origType: g,
                                data: i,
                                handler: n,
                    ...
                    if (m && (l = m.events)) {
                        for (t = (t || "").match(fe) || [""], c = t.length; c--;)
                            if (a = Ae.exec(t[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
                                for (d = ee.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, p = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;)
                ...
                trigger: function(t, n, i, o) {
                    ...
                    if (s = a = i = i || Z, 3 !== i.nodeType && 8 !== i.nodeType && !Le.test(f + ee.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, t = t[ee.expando] ? t : new ee.Event(f, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ee.makeArray(n, [t]), d = ee.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                        if (!o && !d.noBubble && !ee.isWindow(i)) {
                            for (l = d.delegateType || f, Le.test(l + f) || (s = s.parentNode); s; s = s.parentNode)
                                p.push(s), a = s;
                            a === (i.ownerDocument || Z) && p.push(a.defaultView || a.parentWindow || e)
                        }
                        for (r = 0;
                            (s = p[r++]) && !t.isPropagationStopped();)
                            t.type = r > 1 ? l : d.bindType || f, u = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && ee.acceptData(s) && (t.result = u.apply(s, n), t.result === !1 && t.preventDefault());
                    ...
                    if (a[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                        for (s = ee.event.handlers.call(this, e, l), t = 0;
                            ...
                            for (e.currentTarget = o.elem, n = 0;
                                ...
                                (!e.namespace_re || e.namespace_re.test(r.namespace)) && (e.handleObj = r, e.data = r.data, i = ((ee.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
                    ...
                    if (a && l.nodeType && (!e.button || "click" !== e.type))
                        for (; l !== this; l = l.parentNode || this)
                            if (l.disabled !== !0 || "click" !== e.type) {
                                for (i = [], n = 0; a > n; n++)
                                    r = t[n], o = r.selector + " ", void 0 === i[o] && (i[o] = r.needsContext ? ee(o, this).index(l) >= 0 : ee.find(o, this, null, [l]).length), i[o] && i.push(r);
                                i.length && s.push({
                                    elem: l,
                                    handlers: i
                                })
                ...
                fix: function(e) {
                    ...
                    var t, n, i, o = e.type,
                        r = e,
                        s = this.fixHooks[o];
                    for (s || (this.fixHooks[o] = s = Me.test(o) ? this.mouseHooks : Ee.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new ee.Event(r), t = i.length; t--;)
                        n = i[t], e[n] = r[n];
            ...
            _e.optgroup = _e.option, _e.tbody = _e.tfoot = _e.colgroup = _e.caption = _e.thead, _e.th = _e.td, ee.extend({
                ...
                buildFragment: function(e, t, n, i) {
                    for (var o, r, s, a, l, c, u = t.createDocumentFragment(), d = [], p = 0, f = e.length; f > p; p++)
                        ...
                        for (r = r || u.appendChild(t.createElement("div")), s = (De.exec(o) || ["", ""])[1].toLowerCase(), a = _e[s] || _e._default, r.innerHTML = a[1] + o.replace(Pe, "<$1></$2>") + a[2], c = a[0]; c--;)
                            r = r.lastChild;
                ...
                domManip: function(e, t) {
                    ...
                    if (c && (n = ee.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                        for (o = ee.map(v(n, "script"), f), r = o.length; c > l; l++)
                            s = n, l !== d && (s = ee.clone(s, !0, !0), r && ee.merge(o, v(s, "script"))), t.call(this[l], s, l);
                        if (r)
                            for (a = o[o.length - 1].ownerDocument, ee.map(o, h), l = 0; r > l; l++)
                                s = o[l], Ie.test(s.type || "") && !ve.access(s, "globalEval") && ee.contains(a, s) && (s.src ? ee._evalUrl && ee._evalUrl(s.src) : ee.globalEval(s.textContent.replace(Oe, "")))
                    }
                    return this
                }
            }), ee.each({
                ...
                ee.fn[e] = function(e) {
                    for (var n, i = [], o = ee(e), r = o.length - 1, s = 0; r >= s; s++)
                        n = s === r ? this : this.clone(!0), ee(o[s])[t](n), Y.apply(i, n.get());
                ...
                nt = {
                    "*": [function(e, t) {
                        ...
                        if (s && s[3] !== r) {
                            r = r || s[3], o = o || [], s = +i || 1;
                            do
                                a = a || ".5", s /= a, ee.style(n.elem, e, s + r); while (a !== (a = n.cur() / i) && 1 !== a && --l)
                        }
                    ...
                    finish: function(e) {
                        return e !== !1 && (e = e || "fx"), this.each(function() {
                            var t, n = ve.get(this),
                                ...
                                r = ee.timers,
                                s = i ? i.length : 0;
                            for (n.finish = !0, ee.queue(this, e, []), o && o.stop && o.stop.call(this, !0), t = r.length; t--;)
                ...
                toggleClass: function(e, t) {
                    ...
                    return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ee.isFunction(e) ? function(n) {
                        ...
                        if ("string" === n)
                            ...
                            (n === ke || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : ve.get(this, "__className__") || "")
                    })
                },
                hasClass: function(e) {
                    ...
                    select: {
                        ...
                        set: function(e, t) {
                            for (var n, i, o = e.options, r = ee.makeArray(t), s = o.length; s--;)
                                i = o[s], (i.selected = ee.inArray(ee(i).val(), r) >= 0) && (n = !0);
    ...
    9: [function(e, t, n) {
        ! function(e, t, n, i) {
            ...
            o.prototype.transformSupport = function(e) {
                ...
                var t = e.clientX,
                    n = e.clientY;
                !this.orientationSupport && this.relativeInput ? (this.clipRelativeInput && (t = Math.max(t, this.ex), t = Math.min(t, this.ex + this.ew), n = Math.max(n, this.ey), n = Math.min(n, this.ey + this.eh)), this.ix = (t - this.ex - this.ecx) / this.erx,
    ...
    10: [function(e, t, n) {
        ! function() {
            ...
            function n(e, n) {
                if (this.path = e || "", "undefined" != typeof n && null !== n)
            ...
            o.Retina = e, e.configure = function(e) {
                ...
                e.onload = function() {
                    ...
                    for (e = 0; e < o.length; e += 1)
                        n = o[e], n.getAttributeNode("data-no-retina") || r.push(new i(n));
                    t()
                }
            }, e.isRetina = function() {
        ...
        var i = function(e, t) {
            ...
            function c(e) {
                ...
                if (t.freeMode) {
                    ...
                    if (r > 0 && (r = 0), r < -o() && (r = -o()), A.setWrapperTransition(0), A.setWrapperTranslate(r), A.updateActiveSlide(r), 0 === r || r === -o())
                        return
                } else
                    (new Date).getTime() - $ > 60 && (0 > i ? A.swipeNext() : A.swipePrev()), $ = (new Date).getTime();
            ...
            function g(e) {
                ...
                if (t.noSwiping && n && w(n))
                    return !1;
                if (J = !1, A.isTouched = !0, Z = "touchstart" === e.type, !Z && "which" in e && 3 === e.which)
            ...
            function m(e) {
                if (A.isTouched && !t.onlyExternal && (!Z || "mousemove" !== e.type)) {
                    ...
                    if ("undefined" == typeof H && R && (H = !!(H || Math.abs(i - A.touches.startY) > Math.abs(n - A.touches.startX))), "undefined" != typeof H || R || (H = !!(H || Math.abs(i - A.touches.startY) < Math.abs(n - A.touches.startX))), H)
                    ...
                    if (e.assignedToSwiper = !0, t.preventLinks && (A.allowLinks = !1), t.onSlideClick && (A.allowSlideClick = !1), t.autoplay && A.stopAutoplay(!0), !Z || 1 === e.touches.length) {
                        ...
                        if (t.resistance && "100%" === t.resistance && (A.positions.current > 0 && (!t.freeMode || t.freeModeFluid) && (A.positions.current = 0), A.positions.current < -o() && (!t.freeMode || t.freeModeFluid) && (A.positions.current = -o())), !t.followFinger)
                            return;
                        if (t.moveStartThreshold)
                            ...
                            A.setWrapperTranslate(A.positions.current);
                        return (t.freeMode || t.watchActiveIndex) && A.updateActiveSlide(A.positions.current), t.grabCursor && (A.container.style.cursor = "move", A.container.style.cursor = "grabbing", A.container.style.cursor = "-moz-grabbin", A.container.style.cursor = "-webkit-grabbing"), Q || (Q = A.touches.current), K || (K = (new Date).getTime()), A.velocity = (A.touches.current - Q) / ((new Date).getTime() - K) / 2,
                            Math.abs(A.touches.current - Q) < 2 && (A.velocity = 0), Q = A.touches.current, K = (new Date).getTime(), A.callPlugins("onTouchMoveEnd"), t.onTouchMove && A.fireCallback(t.onTouchMove, A, e), !1
                    }
                }
            }
            ...
            function v(e) {
                if (H && A.swipeReset(), !t.onlyExternal && A.isTouched) {
                    ...
                    if (!A.isMoved || A.positions.current > 0 || A.positions.current < -s)
                        return A.swipeReset(), t.onTouchEnd && A.fireCallback(t.onTouchEnd, A, e), void A.callPlugins("onTouchEnd");
                    if (A.isMoved = !1, t.freeMode) {
                        if (t.freeModeFluid) {
                            var a, l = 1e3 * t.momentumRatio,
                                ...
                                d = !1,
                                p = 20 * Math.abs(A.velocity) * t.momentumBounceRatio; - s > u && (t.momentumBounce && A.support.transitions ? (-p > u + s && (u = -s - p), a = -s, d = !0, J = !0) : u = -s), u > 0 && (t.momentumBounce && A.support.transitions ? (u > p && (u = p), a = 0, d = !0, J = !0) : u = 0), 0 !== A.velocity && (l = Math.abs((u - A.positions.current) / A.velocity)),
                                A.setWrapperTranslate(u), A.setWrapperTransition(l), t.momentumBounce && d && A.wrapperTransitionEnd(function() {
            ...
            function w(e) {
                var n = !1;
                do
                    y(e, t.noSwipingClass) && (n = !0), e = e.parentElement; while (!n && e.parentElement && !y(e, t.wrapperClass));
            ...
            function b(e, n, i) {
                ...
                if (A.support.transitions || !t.DOMAnimation)
                    A.setWrapperTranslate(e), A.setWrapperTransition(r);
                else {
            ...
            if (window.getComputedStyle || (window.getComputedStyle = function(e, t) {
                ...
                A.callPlugins = function(e, t) {
                    ...
                    if (i !== A.width || o !== A.height || e) {
                        ...
                        if (e && A.calcSlides(n), "auto" === t.slidesPerView) {
                            var f = 0,
                                h = 0;
                            t.slidesOffset > 0 && (p.style.paddingLeft = "", p.style.paddingRight = "", p.style.paddingTop = "", p.style.paddingBottom = ""), p.style.width = "", p.style.height = "", t.offsetPxBefore > 0 && (R ? A.wrapperLeft = t.offsetPxBefore : A.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (R ? A.wrapperRight = t.offsetPxAfter : A.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (R ? (A.wrapperLeft = (I - this.slides[0].getWidth(!0, t.roundLengths)) / 2,
                                ...
                                R ? (A.wrapperLeft >= 0 && (p.style.paddingLeft = A.wrapperLeft + "px"), A.wrapperRight >= 0 && (p.style.paddingRight = A.wrapperRight + "px")) : (A.wrapperTop >= 0 && (p.style.paddingTop = A.wrapperTop + "px"), A.wrapperBottom >= 0 && (p.style.paddingBottom = A.wrapperBottom + "px")), u = 0;
                            var g = 0;
                                ...
                                if (t.centeredSlides) {
                                    ...
                                    if (m > I) {
                                        if (t.slidesPerViewFit)
                                            A.snapGrid.push(u + A.wrapperLeft), A.snapGrid.push(u + m - I + A.wrapperLeft);
                                        else
                                    ...
                                    if (m > I)
                                        if (t.slidesPerViewFit)
                                            A.snapGrid.push(u), A.snapGrid.push(u + m - I);
                                        else if (0 !== I)
                            ...
                            p.style.width = "", p.style.height = "", l = A.slides[0].getWidth(!0, t.roundLengths), c = A.slides[0].getHeight(!0, t.roundLengths), j = R ? l : c, p.style.width = l + "px", p.style.height = c + "px", D = R ? l : c;
                        else {
                            if (t.calculateHeight) {
                                for (a = 0, c = 0, R || (A.container.style.height = ""), p.style.height = "", d = 0; d < A.slides.length; d++)
                                    A.slides[d].style.height = "", a = Math.max(A.slides[d].getHeight(!0), a), R || (c += A.slides[d].getHeight(!0));
                                s = a, A.height = s, R ? c = s : (I = s, A.container.style.height = I + "px")
                            } else
                                s = R ? A.height : A.height / t.slidesPerView, t.roundLengths && (s = Math.ceil(s)), c = R ? A.height : A.slides.length * s;
                            for (r = R ? A.width / t.slidesPerView : A.width, t.roundLengths && (r = Math.ceil(r)), l = R ? A.slides.length * r : A.width, D = R ? r : s, t.offsetSlidesBefore > 0 && (R ? A.wrapperLeft = D * t.offsetSlidesBefore : A.wrapperTop = D * t.offsetSlidesBefore), t.offsetSlidesAfter > 0 && (R ? A.wrapperRight = D * t.offsetSlidesAfter : A.wrapperBottom = D * t.offsetSlidesAfter), t.offsetPxBefore > 0 && (R ? A.wrapperLeft = t.offsetPxBefore : A.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (R ? A.wrapperRight = t.offsetPxAfter : A.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (R ? (A.wrapperLeft = (I - D) / 2,
                                    A.wrapperRight = (I - D) / 2) : (A.wrapperTop = (I - D) / 2,
                                    A.wrapperBottom = (I - D) / 2)),
                                R ? (A.wrapperLeft > 0 && (p.style.paddingLeft = A.wrapperLeft + "px"), A.wrapperRight > 0 && (p.style.paddingRight = A.wrapperRight + "px")) : (A.wrapperTop > 0 && (p.style.paddingTop = A.wrapperTop + "px"), A.wrapperBottom > 0 && (p.style.paddingBottom = A.wrapperBottom + "px")), j = R ? l + A.wrapperRight + A.wrapperLeft : c + A.wrapperTop + A.wrapperBottom, parseFloat(l) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (p.style.width = l + "px"), parseFloat(c) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (p.style.height = c + "px"), u = 0, A.snapGrid = [], A.slidesGrid = [], d = 0; d < A.slides.length; d++)
                                A.snapGrid.push(u), A.slidesGrid.push(u), u += D, parseFloat(r) > 0 && (!t.cssWidthAndHeight || "height" === t.cssWidthAndHeight) && (A.slides[d].style.width = r + "px"), parseFloat(s) > 0 && (!t.cssWidthAndHeight || "width" === t.cssWidthAndHeight) && (A.slides[d].style.height = s + "px")
                        }
                ...
                A.swipeNext = function(e, n) {
                    ...
                    if ("auto" === t.slidesPerView) {
                        ...
                        n = 0 > i ? Math.round(i / r) * r : 0, i <= -o() && (n = -o());
                        ...
                        if (A.activeIndex === A.slides.length && (A.activeIndex = A.slides.length - 1), A.activeIndex < 0 && (A.activeIndex = 0), A.slides[A.activeIndex]) {
                            if (A.calcVisibleSlides(e), A.support.classList) {
                                ...
                                for (n = 0; n < A.slides.length; n++)
                                    r = A.slides[n], r.classList.remove(t.slideActiveClass), A.visibleSlides.indexOf(r) >= 0 ? r.classList.add(t.slideVisibleClass) : r.classList.remove(t.slideVisibleClass);
                                ...
                                for (n = 0; n < A.slides.length; n++)
                                    A.slides[n].className = A.slides[n].className.replace(s, "").replace(a, ""), A.visibleSlides.indexOf(A.slides[n]) >= 0 && (A.slides[n].className += " " + t.slideVisibleClass);
                ...
                A.startAutoplay = function() {
                    ...
                    if (A.support.transitions) {
                        ...
                        te && clearInterval(te), te = void 0, A.callPlugins("onAutoplayStop"), t.onAutoplayStop && A.fireCallback(t.onAutoplayStop, A)
                    ...
                    if (0 !== A.slides.length) {
                        ...
                        for (P.innerHTML = u, A.loopCreated = !0, A.calcSlides(), e = 0; e < A.slides.length; e++)
